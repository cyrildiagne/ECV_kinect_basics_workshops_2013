...
void setupSliders()
{
  ...
  cp5.addSlider("frequence").setPosition(5, 5).setRange(0.2, 2);
  cp5.addSlider("initScale").setPosition(5,20).setRange(0, 1.5);
  cp5.addSlider("initAlpha").setPosition(5,35).setRange(0, 1);
  cp5.addSlider("alphaModifier").setPosition(5,50).setRange(0.85, 1.5);
